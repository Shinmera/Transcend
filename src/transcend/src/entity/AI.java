...
public class AI {
    ...
    public void update(){
        ...
        for(int i=0;i<blockIDs.length;i++){
            ...
            if((block.checkInside(e.x-e.w*0.5,   e.y+e.h*1.5)||block.checkInside(e.x-e.w*1.5,   e.y+e.h*1.5))&&e.ground!=null)choices.add(CHOICE_TL);
            if((block.checkInside(e.x+e.w*1.5,   e.y+e.h*1.5)||block.checkInside(e.x+e.w*2.5,   e.y+e.h*1.5))&&e.ground!=null)choices.add(CHOICE_TR);
